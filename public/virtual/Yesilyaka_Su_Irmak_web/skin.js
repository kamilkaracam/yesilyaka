...
// Generated Cum Eki 26 09:28:11 2018
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._spot15_level1=document.createElement('div');
		this._spot15_level1.ggId="spot15 Level1";
		this._spot15_level1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._spot15_level1.ggVisible=true;
		this._spot15_level1.className="ggskin ggskin_rectangle ";
		this._spot15_level1.ggType='rectangle';
		hs ='';
		...
		hs+='width : 15px;';
		hs+='pointer-events:auto;';
		this._spot15_level1.setAttribute('style',hs);
		this._spot15_level1.style[domTransform + 'Origin']='50% 50%';
		me._spot15_level1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._spot15_level1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._spot15_level1.onclick=function (e) {
			me.player.openNext("{node33}","");
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=483;me._radar_level1.ggParameter.ry=155;
		...
		this._spot15_level1.onmouseover=function (e) {
		...
		this._spot15_level1.onmouseout=function (e) {
			me._location_next_text_level1.style[domTransition]='none';
			me._location_next_text_level1.ggParameter.sx=0;me._location_next_text_level1.ggParameter.sy=0;
			me._location_next_text_level1.style[domTransform]=parameterToTransform(me._location_next_text_level1.ggParameter);
		}
		this._spot15_level1.ggUpdatePosition=function (useTransition) {
		}
		this._container_spots_and_radar_beam_level1.appendChild(this._spot15_level1);
		this._spot14_level1=document.createElement('div');
		this._spot14_level1.ggId="spot14 Level1";
		this._spot14_level1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._spot14_level1.ggVisible=true;
		this._spot14_level1.className="ggskin ggskin_rectangle ";
		this._spot14_level1.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'background-clip : padding-box;';
		hs+='background-clip : padding-box;';
		hs+=cssPrefix + 'border-radius : 8px;';
		...
		hs+='width : 15px;';
		hs+='pointer-events:auto;';
		this._spot14_level1.setAttribute('style',hs);
		this._spot14_level1.style[domTransform + 'Origin']='50% 50%';
		me._spot14_level1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._spot14_level1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._spot14_level1.onclick=function (e) {
			me.player.openNext("{node32}","");
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=248;me._radar_level1.ggParameter.ry=345;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		}
		this._spot14_level1.onmouseover=function (e) {
			me._location_next_text_level1.ggText="<pre style=\"font-size:1.3em; margin-top:0px; margin-bottom:0px; font-family:Century Gothic;\">&nbsp;Ana Giri\u015f&nbsp;<\/pre>";
			me._location_next_text_level1.ggTextDiv.innerHTML=me._location_next_text_level1.ggText;
			if (me._location_next_text_level1.ggUpdateText) {
				me._location_next_text_level1.ggUpdateText=function() {
		...
		this._spot14_level1.onmouseout=function (e) {
			me._location_next_text_level1.style[domTransition]='none';
			me._location_next_text_level1.ggParameter.sx=0;me._location_next_text_level1.ggParameter.sy=0;
			me._location_next_text_level1.style[domTransform]=parameterToTransform(me._location_next_text_level1.ggParameter);
		}
		this._spot14_level1.ggUpdatePosition=function (useTransition) {
		}
		this._container_spots_and_radar_beam_level1.appendChild(this._spot14_level1);
		this._spot13_level1=document.createElement('div');
		this._spot13_level1.ggId="spot13 Level1";
		this._spot13_level1.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._spot13_level1.ggVisible=true;
		this._spot13_level1.className="ggskin ggskin_rectangle ";
		this._spot13_level1.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'background-clip : padding-box;';
		hs+='background-clip : padding-box;';
		hs+=cssPrefix + 'border-radius : 8px;';
		...
		hs+='width : 15px;';
		hs+='pointer-events:auto;';
		this._spot13_level1.setAttribute('style',hs);
		this._spot13_level1.style[domTransform + 'Origin']='50% 50%';
		me._spot13_level1.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._spot13_level1.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._spot13_level1.onclick=function (e) {
			me.player.openNext("{node31}","");
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=251;me._radar_level1.ggParameter.ry=262;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		}
		this._spot13_level1.onmouseover=function (e) {
			me._location_next_text_level1.ggText="<pre style=\"font-size:1.3em; margin-top:0px; margin-bottom:0px; font-family:Century Gothic;\">&nbsp;Ana Giri\u015f&nbsp;<\/pre>";
			me._location_next_text_level1.ggTextDiv.innerHTML=me._location_next_text_level1.ggText;
			if (me._location_next_text_level1.ggUpdateText) {
				me._location_next_text_level1.ggUpdateText=function() {
		...
		this._spot13_level1.onmouseout=function (e) {
			me._location_next_text_level1.style[domTransition]='none';
			me._location_next_text_level1.ggParameter.sx=0;me._location_next_text_level1.ggParameter.sy=0;
			me._location_next_text_level1.style[domTransform]=parameterToTransform(me._location_next_text_level1.ggParameter);
		}
		this._spot13_level1.ggUpdatePosition=function (useTransition) {
		}
		this._container_spots_and_radar_beam_level1.appendChild(this._spot13_level1);
		...
		this._spot12_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=427;me._radar_level1.ggParameter.ry=302;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot11_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=428;me._radar_level1.ggParameter.ry=332;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot10_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=353;me._radar_level1.ggParameter.ry=397;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot9_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=344;me._radar_level1.ggParameter.ry=332;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot8_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=340;me._radar_level1.ggParameter.ry=261;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot7_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=368;me._radar_level1.ggParameter.ry=203;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot6_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=338;me._radar_level1.ggParameter.ry=157;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot5_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=339;me._radar_level1.ggParameter.ry=206;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot4_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=95;me._radar_level1.ggParameter.ry=63;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot3_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=84;me._radar_level1.ggParameter.ry=157;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot2_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=208;me._radar_level1.ggParameter.ry=191;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot1_level1.onclick=function (e) {
			...
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.rx=257;me._radar_level1.ggParameter.ry=197;
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
			me._radar_level1.style[domTransition]='none';
			me._radar_level1.ggParameter.a="0.0000";
			me._radar_level1.style[domTransform]=parameterToTransform(me._radar_level1.ggParameter);
		...
		this._spot20_levelz=document.createElement('div');
		this._spot20_levelz.ggId="spot20 LevelZ";
		this._spot20_levelz.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._spot20_levelz.ggVisible=true;
		this._spot20_levelz.className="ggskin ggskin_rectangle ";
		this._spot20_levelz.ggType='rectangle';
		hs ='';
		hs+=cssPrefix + 'background-clip : padding-box;';
		hs+='background-clip : padding-box;';
		hs+=cssPrefix + 'border-radius : 8px;';
		...
		hs+='width : 15px;';
		hs+='pointer-events:auto;';
		this._spot20_levelz.setAttribute('style',hs);
		this._spot20_levelz.style[domTransform + 'Origin']='50% 50%';
		me._spot20_levelz.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		}
		me._spot20_levelz.ggElementNodeId=function() {
			if ((this.parentNode) && (this.parentNode.ggElementNodeId)) {
				return this.parentNode.ggElementNodeId();
			}
			return me.player.getCurrentNode();
		}
		this._spot20_levelz.onclick=function (e) {
			me.player.openNext("{node35}","");
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=520;me._radar_levelz.ggParameter.ry=72;
		...
		this._spot20_levelz.onmouseover=function (e) {
		...
		this._spot20_levelz.onmouseout=function (e) {
			me._location_next_text_levelz.style[domTransition]='none';
			me._location_next_text_levelz.ggParameter.sx=0;me._location_next_text_levelz.ggParameter.sy=0;
			me._location_next_text_levelz.style[domTransform]=parameterToTransform(me._location_next_text_levelz.ggParameter);
		}
		this._spot20_levelz.ggUpdatePosition=function (useTransition) {
		}
		this._container_spots_and_radar_beam_levelz.appendChild(this._spot20_levelz);
		...
		this._spot19_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=522;me._radar_levelz.ggParameter.ry=219;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot18_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=217;me._radar_levelz.ggParameter.ry=172;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot17_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=431;me._radar_levelz.ggParameter.ry=164;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot16_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=372;me._radar_levelz.ggParameter.ry=167;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot15_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=361;me._radar_levelz.ggParameter.ry=347;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot14_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=407;me._radar_levelz.ggParameter.ry=377;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot13_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=451;me._radar_levelz.ggParameter.ry=305;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot12_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=403;me._radar_levelz.ggParameter.ry=219;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot11_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=304;me._radar_levelz.ggParameter.ry=221;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot10_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=209;me._radar_levelz.ggParameter.ry=341;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot9_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=245;me._radar_levelz.ggParameter.ry=227;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot7_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=144;me._radar_levelz.ggParameter.ry=169;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot6_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=55;me._radar_levelz.ggParameter.ry=203;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot5_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=141;me._radar_levelz.ggParameter.ry=439;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot4_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=321;me._radar_levelz.ggParameter.ry=435;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot3_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=324;me._radar_levelz.ggParameter.ry=558;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot2_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=141;me._radar_levelz.ggParameter.ry=567;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
		...
		this._spot1_levelz.onclick=function (e) {
			...
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.rx=55;me._radar_levelz.ggParameter.ry=586;
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
			me._radar_levelz.style[domTransition]='none';
			me._radar_levelz.ggParameter.a="0.0000";
			me._radar_levelz.style[domTransform]=parameterToTransform(me._radar_levelz.ggParameter);
	...
	this.hotspotProxyClick=function(id) {
		if (id=='33') {
			me._spot15_level1.onclick();
		}
		if (id=='32') {
			me._spot14_level1.onclick();
		}
		if (id=='31') {
			me._spot13_level1.onclick();
		}
		if (id=='30') {
	...
	this.hotspotProxyOver=function(id) {
		if (id=='33') {
			me._spot15_level1.onmouseover();
		}
		if (id=='32') {
			me._spot14_level1.onmouseover();
		}
		if (id=='31') {
			me._spot13_level1.onmouseover();
		}
		if (id=='30') {
	...
	this.hotspotProxyOut=function(id) {
		if (id=='33') {
			me._spot15_level1.onmouseout();
		}
		if (id=='32') {
			me._spot14_level1.onmouseout();
		}
		if (id=='31') {
			me._spot13_level1.onmouseout();
		}
		if (id=='30') {
